@include('layout.header_home')
            ...
            <main id="main-container">
                            ...
                            <div class="row no-gutters w-100 py-100 overflow-hidden">
                                <div class="col-md-5 py-30 d-flex align-items-center invisible" data-toggle="appear">
                                    <div class="text-center text-md-left">
                                        <span class="d-inline-block bg-body-light rounded-pill py-5 px-15 mb-15 font-w600">Selamat datang di aplikasi</span>
                                        <h1 class="font-w600 font-size-h2 mb-20">
                                            Penerimaan Peserta Didik Baru (PPDB)
                                        </h1>
                                        <h2 class="font-w500 font-size-h2 mb-20">
                                            SMAS Nadhamedia
                                        </h2>
                                        ...
                                        <a class="btn btn-hero btn-alt-secondary" href="be_pages_dashboard.html">
                                            <i class="fa fa-arrow-right text-muted mr-5"></i> Baca Informasi PPDB
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-7 py-30 d-none d-md-flex align-items-md-center justify-content-md-end invisible" data-toggle="appear" data-class="animated fadeInRight">
                                    <img class="img-fluid" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-hero.png" srcset="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-hero@2x.png 2x" alt="Hero Promo">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row nice-copy my-10">
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_dashboard.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-default.png" alt="Dashboard Default">
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_classic.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-classic.png" alt="Dashboard Classic">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_clean.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-clean.png" alt="Dashboard Clean">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_social.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-social.png" alt="Dashboard Social">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_corporate.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-corporate.png" alt="Dashboard Corporate">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_minimal.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-minimal.png" alt="Dashboard Minimal">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_pop.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-pop.png" alt="Dashboard Pop">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_dark.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-dark.png" alt="Dashboard Dark">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="db_medical.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-db-medical.png" alt="Dashboard Medical">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                            ...
                            <div class="row nice-copy my-10">
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_crypto_dashboard.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-crypto.png" alt="Page Pack Crypto">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_ecom_dashboard.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-ecommerce.png" alt="Page Pack e-Commerce">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_elearning_courses.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-elearning.png" alt="Page Pack e-Learning">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_forum_categories.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-forum.png" alt="Page Pack Forum">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_auth_all.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-auth.png" alt="Page Pack Authentication">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                                ...
                                <div class="col-md-4 py-20">
                                    <a class="options-container push" href="be_pages_error_all.html">
                                        <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/preview-page-pack-error.png" alt="Page Pack Error">
                                        <div class="options-overlay bg-white-op-90">
                                            <div class="options-overlay-content h5 font-w700 text-uppercase">
                                                <i class="fa fa-link fa-4x"></i>
                                            </div>
                        ...
                        <div class="row no-gutters pull-b text-center overflow-hidden">
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                                <a class="options-container" href="be_pages_dashboard.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-layout-backend.png" srcset="assets/media/various/landing-promo-layout-backend@2x.png 2x" alt="Backend Promo">
                            ...
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                                <a class="options-container" href="db_classic.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-layout-classic-dashboard.png" srcset="assets/media/various/landing-promo-layout-classic-dashboard@2x.png 2x" alt="Classic Dashboard Promo">
                                    <div class="options-overlay bg-white">
                                        <div class="options-overlay-content">
                                            <h3 class="h5 font-w700 text-uppercase mb-5">
                            ...
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                                <a class="options-container" href="be_layout_api.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-layout-api.png" srcset="assets/media/various/landing-promo-layout-api@2x.png 2x" alt="Layout API Promo">
                                    <div class="options-overlay bg-white">
                                        <div class="options-overlay-content">
                                            <h3 class="h5 font-w700 text-uppercase mb-5">
                        ...
                        <div class="row no-gutters pull-b text-center overflow-hidden">
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                                <a class="options-container" href="be_ui_grid.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-bootstrap4-grid.png" srcset="assets/media/various/landing-promo-bootstrap4-grid@2x.png 2x" alt="Bootstrap 4 Grid Promo">
                            ...
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                                <a class="options-container" href="be_ui_typography.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-bootstrap4-typography.png" srcset="assets/media/various/landing-promo-bootstrap4-typography@2x.png 2x" alt="Bootstrap 4 Typography Promo">
                                    <div class="options-overlay bg-body-light">
                                        <div class="options-overlay-content">
                                            <h3 class="h5 font-w700 text-uppercase mb-5">
                                                Explore
                            ...
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                                <a class="options-container" href="be_ui_buttons.html">
                                    <img class="img-fluid options-item" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-bootstrap4-buttons.png" srcset="assets/media/various/landing-promo-bootstrap4-buttons@2x.png 2x" alt="Bootstrap 4 Buttons Promo">
                                    <div class="options-overlay bg-body-light">
                                        <div class="options-overlay-content">
                                            <h3 class="h5 font-w700 text-uppercase mb-5">
                                                Explore
                    ...
                    <div class="content content-full">
                        ...
                        <div class="row no-gutters justify-content-center pull-b text-center overflow-hidden">
                            <div class="col-sm-6 invisible" data-toggle="appear" data-class="animated zoomIn">
                                <img class="img-fluid" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-smart-tools.png" srcset="assets/media/various/landing-promo-smart-tools@2x.png 2x" alt="Smart Tools Promo">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-body-light">
                    <div class="content content-full">
                        ...
                        <div class="row no-gutters pull-b text-center overflow-hidden">
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                                <img class="img-fluid" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-developer-minded-php.png" srcset="assets/media/various/landing-promo-developer-minded-php@2x.png 2x" alt="Developer Minded PHP Promo">
                            </div>
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="250">
                                <img class="img-fluid" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-developer-minded-docs.png" srcset="assets/media/various/landing-promo-developer-minded-docs@2x.png 2x" alt="Developer Minded Docs Promo">
                            </div>
                            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200" data-timeout="500">
                                <img class="img-fluid" src="{{ asset('/ladun/codebase') }}/assets/media/various/landing-promo-developer-minded-html.png" srcset="assets/media/various/landing-promo-developer-minded-html@2x.png 2x" alt="Developer Minded HTML Promo">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        -->
        <script src="{{ asset('/ladun/codebase') }}/assets/js/codebase.core.min.js"></script>
        ...
        -->
        <script src="{{ asset('/ladun/codebase') }}/assets/js/codebase.app.min.js"></script>
    </body>
</html>